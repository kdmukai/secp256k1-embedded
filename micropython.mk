...
CFLAGS_USERMOD += -I$(SECP256K1_MODULE_DIR)/secp256k1 -I$(SECP256K1_MODULE_DIR)/secp256k1/src -I$(SECP256K1_MODULE_DIR)/mpy/config -DHAVE_CONFIG_H -Wno-unused-function -O2